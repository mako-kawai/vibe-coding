...
const CACHE_NAME = `${CACHE_PREFIX}v2-20260822-r3`;
...
const CORE_FILES = [
  ...
  './js/courses-page.js', './js/courses-page.js?v=20260822', './js/notes-page.js', './js/schedule-page.js', './js/transcript-page.js', './js/transcript-page.js?v=20260822',
